...
jlong
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_nativeInit(
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_nativeDestroy(
...
jint
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_openDir(
...
jobject
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_stat(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return NULL;
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_createFile(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return;
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_mkdir(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return;
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_rename(
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_unlink(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return;
...
void
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_rmdir(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return;
...
jint
Java_com_evideo_sambaprovider_nativefacade_NativeSambaFacade_openFile(
...
jobject Java_com_evideo_sambaprovider_nativefacade_SambaDir_readDir(
...
void Java_com_evideo_sambaprovider_nativefacade_SambaDir_close(
        JNIEnv *env, jobject instance, jlong pointer, jint dh) {
    SambaClient::SambaClient *client =
            reinterpret_cast<SambaClient::SambaClient *>(pointer);
...
jobject Java_com_evideo_sambaprovider_nativefacade_SambaFile_fstat(
        JNIEnv *env,
        jobject instance,
        jlong pointer,
        jint fd) {
...
jlong Java_com_evideo_sambaprovider_nativefacade_SambaFile_seek(
        JNIEnv *env,
        jobject instance,
        jlong pointer,
        jint fd,
...
jlong Java_com_evideo_sambaprovider_nativefacade_SambaFile_read(
        JNIEnv *env,
        jobject instance,
        jlong pointer,
        jint fd,
...
jlong Java_com_evideo_sambaprovider_nativefacade_SambaFile_write(
        JNIEnv *env,
        jobject instance,
        jlong pointer,
        jint fd,
...
void Java_com_evideo_sambaprovider_nativefacade_SambaFile_close(
...
jlong Java_com_evideo_sambaprovider_nativefacade_NativeCredentialCache_nativeInit(
        JNIEnv *env, jobject instance) {
    return reinterpret_cast<jlong>(new SambaClient::CredentialCache());
}

void Java_com_evideo_sambaprovider_nativefacade_NativeCredentialCache_putCredential(
        JNIEnv *env, jobject instance, jlong pointer,
...
void Java_com_evideo_sambaprovider_nativefacade_NativeCredentialCache_removeCredential(
        JNIEnv *env, jobject instance, jlong pointer, jstring uri_) {
    const char *uri = env->GetStringUTFChars(uri_, 0);
    if (uri == NULL) {
        return;
...
void Java_com_evideo_sambaprovider_SambaConfiguration_setEnv(
