...
package com.evideo.sambaprovider.document;
  ...
  public String getMimeType() {
    switch (mEntry.getType()) {
      ...
      case DirectoryEntry.PRINTER_SHARE:
        throw new UnsupportedOperationException(
            "Unsupported type of Samba directory entry " + String.valueOf(mEntry.getType()));
...
//    final Uri uri = SMB_BASE_URI.buildUpon().authority(host).build();
