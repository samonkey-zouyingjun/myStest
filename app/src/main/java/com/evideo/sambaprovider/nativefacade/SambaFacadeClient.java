...
class SambaFacadeClient extends BaseClient implements SmbFacade {
    ...
    public ParcelFileDescriptor openProxyFile(
        ...
        SambaProxyFileCallback call = new SambaProxyFileCallback(uri, file, bufferPool, callback);

//        return storageManager.openProxyFileDescriptor(
//                parseMode,
//                call,
//                mHandler);
        return getFileDescriptor(storageManager,parseMode,call);
    }

    private ParcelFileDescriptor getFileDescriptor(StorageManager storageManager,int parseMode,
                                                   SambaProxyFileCallback call){
