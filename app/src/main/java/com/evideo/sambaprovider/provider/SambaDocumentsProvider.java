...
package com.evideo.sambaprovider.provider;
...
import com.evideo.sambaprovider.base.DocumentCursor;
import com.evideo.sambaprovider.base.OnTaskFinishedCallback;
import com.evideo.sambaprovider.cache.CacheResult;
import com.evideo.sambaprovider.cache.DocumentCache;
import com.evideo.sambaprovider.document.DocumentMetadata;
import com.evideo.sambaprovider.document.LoadChildrenTask;
import com.evideo.sambaprovider.document.LoadDocumentTask;
import com.evideo.sambaprovider.document.LoadStatTask;
...
import static com.evideo.sambaprovider.base.DocumentIdHelper.toDocumentId;
import static com.evideo.sambaprovider.base.DocumentIdHelper.toRootId;
import static com.evideo.sambaprovider.base.DocumentIdHelper.toUri;
import static com.evideo.sambaprovider.base.DocumentIdHelper.toUriString;


public class SambaDocumentsProvider extends DocumentsProvider {

  public static final String AUTHORITY = "com.evideo.sambaprovider";
  ...
  private final ShareManager.MountedShareChangeListener mShareChangeListener = new ShareManager.MountedShareChangeListener() {
    @Override
    ...
    for (String uri : mShareManager) {
      ...
      try(CacheResult result = mCache.get(parsedUri)) {
        ...
        cursor.addRow(new Object[] {
            ...
            name,
            Root.FLAG_SUPPORTS_CREATE | Root.FLAG_SUPPORTS_IS_CHILD | 32,//Root.FLAG_SUPPORTS_EJECT
    ...
    for (int i = 0; i < projection.length; ++i) {
      switch (projection[i]) {
        ...
        case Document.COLUMN_FLAGS:
          ...
          flag |= 1024;//Document.FLAG_SUPPORTS_REMOVE;
          flag |= 256;//Document.FLAG_SUPPORTS_MOVE;
          row[i] = flag;
          break;
